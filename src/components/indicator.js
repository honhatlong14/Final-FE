...
const Indicator = ({ open}) => {
  ...
  return ReactDOM.createPortal(
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="w-screen flex items-end justify-center min-h-screen text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block align-bottom rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:align-middle sm:max-w-max sm:w-full">
    ...
    document.getElementById("app-indicator")
  );
};
