...
import {createUser, getSingleUser, register as registerApi, updateUser} from "../../../apiServices";
...
const CreateUserPage = ({authenticateReducer}) => {
    ...
    const onSubmit = async (formData) => {
        const {status, data} = await createUser({...formData}, jwtToken);
        if (status === 200) {
            reset({
                avatarFile: '',
                acceptTerms: true,
        ...
        <>
            ...
            >
                <div
                    ...
                    <div>
                        <h2 className='text-center font-bold mt-[30px] mb-[14px] text-[30px] leading-9'>Create User</h2>
                    </div>
